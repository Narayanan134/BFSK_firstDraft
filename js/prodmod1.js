let sourceWaveCanvas = document.getElementById('phi1WaveCanvas');
...
const vertical_scale_element = document.getElementById("pm1_vertical_scale_factor");
const horizontal_scale_element = document.getElementById("pm1_horizontal_scale_factor");
...
export function drawProd1Wave() {
    ...
    plotSine(sourceWaveCtx, wave_amplitude, wave_frequency, orgx, mid_of_line, vertical_scaling_factor, horizontal_scaling_factor,f1_wave);
    requestAnimationFrame(drawProd1Wave);
}