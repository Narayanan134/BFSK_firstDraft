...
export class OE extends Block {
    constructor (x, y, w, h) {
        super(x, y, w, h, 'ON-OFF\nLEVEL ENCODER', null, true);
...
export class INVM extends Block {
    constructor (x, y, w, h) {
        super(x, y, w, h, 'INVERTER', null, true);
        this.input = new Point(this.cx - 7, this.cy + this.ch / 2);
        this.output = new Point(this.cx + this.cw + 7, this.cy + this.ch / 2);
        connectionNodes.push(this.input);
        connectionNodes.push(this.output);
...
export class PM1 extends Block {
    ...
    doubleClickModal() { return 'phi1WaveGraph'; }
}
...
export class PM2 extends Block {
    ...
    doubleClickModal() { return 'phi2WaveGraph'; }
}
...
export class AD extends Block {
    ...
    doubleClickModal() { return 'adderWaveGraph'; }
}
...
export class CORR1 extends Block {
    constructor (x, y, w, h) {
...
export class CORR2 extends Block {
    constructor (x, y, w, h) {
        super(x, y, w, h, 'CORRELATOR', null, true);
        this.input = new Point(this.cx - 7, this.cy + this.ch / 2);
        this.output = new Point(this.cx + this.cw + 7, this.cy + this.ch / 2);
...
export class phi1 extends Block {
    constructor (x, y, w, h) {
        super(x, y, w, h, 'Phi1(t)', null, true);
        this.input = new Point(this.cx - 7, this.cy + this.ch / 2);
        this.output = new Point(this.cx + this.cw + 7, this.cy + this.ch / 2);
        connectionNodes.push(this.input);
        connectionNodes.push(this.output);
...
export class phi2 extends Block {
    constructor (x, y, w, h) {
        super(x, y, w, h, 'Phi2(t)', null, true);
        this.input = new Point(this.cx - 7, this.cy + this.ch / 2);
        this.output = new Point(this.cx + this.cw + 7, this.cy + this.ch / 2);
        connectionNodes.push(this.input);
        connectionNodes.push(this.output);
...
export class phi3 extends Block {
    constructor (x, y, w, h) {
        super(x, y, w, h, 'Phi1(t)', null, true);
        this.input = new Point(this.cx - 7, this.cy + this.ch / 2);
        this.output = new Point(this.cx + this.cw + 7, this.cy + this.ch / 2);
...
export class phi4 extends Block {
    constructor (x, y, w, h) {
        super(x, y, w, h, 'Phi2(t)', null, true);
        this.input = new Point(this.cx - 7, this.cy + this.ch / 2);
        this.output = new Point(this.cx + this.cw + 7, this.cy + this.ch / 2);
